...
def contact():
    if request.method == 'POST':
        ...
        spam_test_1 = 'http'
        spam_test_2 = 'https'
        if spam_test_1 not in name and spam_test_2 not in name:
            print('Passed spam test as positive.')
            if email == email2:
            ...
            print('failed spam test.')
            spam_report = f'{datetime.now()} -- Spam detected -- email: {email}\n'
